...
public class ImageUtil {
    ...
    public static Bitmap getBitmap(@DrawableRes int drawableRes) {
        Drawable d = ContextCompat.getDrawable(AndroidCodeTestApplication.getAppContext(), drawableRes);
        return getBitmap(d);
    }
    ...
    public static Bitmap getBitmap(Uri uri) throws IOException {
        return MediaStore.Images.Media.getBitmap(AndroidCodeTestApplication.getAppContext().getContentResolver(), uri);
    }
